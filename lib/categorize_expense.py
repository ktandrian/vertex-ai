CATEGORIES_MAP = {
    ...
    "Purchase-Testing_Ticket-testing": {
        ...
        "COA": "403020",
        "Category Description": "Cost incurred by BU for testing the system/integration with biz partner in which the company really pays the booking to biz partner"
    },
    ...
    "Employee-welfare_Employee-Welfare": {
        ...
        "Sub Category": "Employee Welfare",
        "COA": "504006",
        "Category Description": "other employee's benefit that does not cover in other sub-category"
    },
    ...
    "Default_Uncategorized": {
        ...
        "COA": "999999",
        "Category Description": "Item could not be automatically classified and requires manual review."
    }
}
